...
public class Npc extends Gladiator {
	...
	public void npcStatus(Player p) {
		if (p.level <= 5) {
			...
			this.level = r.ints(6, 10).findFirst().getAsInt();
			this.hp = r.ints(50, 99).findFirst().getAsInt();
			this.str = r.ints(20, 30).findFirst().getAsInt();
			this.dex = r.ints(12, 24).findFirst().getAsInt();
			this.exp = r.ints(20, 40).findFirst().getAsInt();
			this.money = r.ints(10, 20).findFirst().getAsInt();
		} else if (p.level <= 15) {
			this.level = r.ints(11, 15).findFirst().getAsInt();
			this.hp = r.ints(85, 150).findFirst().getAsInt();
			this.str = r.ints(30, 60).findFirst().getAsInt();
			this.dex = r.ints(20, 30).findFirst().getAsInt();
			this.exp = r.ints(40, 60).findFirst().getAsInt();
			this.money = r.ints(20, 40).findFirst().getAsInt();
		} else if (p.level <= 20) {
			this.level = r.ints(16, 20).findFirst().getAsInt();
			this.hp = r.ints(250, 400).findFirst().getAsInt();
			this.str = r.ints(130, 160).findFirst().getAsInt();
			this.dex = r.ints(40, 65).findFirst().getAsInt();
			this.exp = r.ints(50, 90).findFirst().getAsInt();
			;
			this.money = r.ints(35, 60).findFirst().getAsInt();
		} else if (p.level <= 25) {
			this.level = r.ints(21, 25).findFirst().getAsInt();
			this.hp = r.ints(350, 500).findFirst().getAsInt();
			this.str = r.ints(150, 250).findFirst().getAsInt();
			this.dex = r.ints(75, 120).findFirst().getAsInt();
			this.exp = r.ints(90, 120).findFirst().getAsInt();
			this.money = r.ints(80, 150).findFirst().getAsInt();
		} else if (p.level <= 30) {
			this.level = r.ints(26, 30).findFirst().getAsInt();
			this.hp = r.ints(450, 750).findFirst().getAsInt();
			this.str = r.ints(250, 350).findFirst().getAsInt();
			...
			this.level = r.ints(31, 35).findFirst().getAsInt();
			this.hp = r.ints(700, 900).findFirst().getAsInt();
			this.str = r.ints(400, 500).findFirst().getAsInt();
			this.dex = r.ints(200, 250).findFirst().getAsInt();
			this.exp = r.ints(200, 300).findFirst().getAsInt();
			this.money = r.ints(200, 350).findFirst().getAsInt();
		} else if (p.level <= 40) {
			this.level = r.ints(36, 40).findFirst().getAsInt();
			this.hp = r.ints(1000, 1300).findFirst().getAsInt();
			this.str = r.ints(600, 700).findFirst().getAsInt();
			...
			this.level = r.ints(41, 45).findFirst().getAsInt();
			this.hp = r.ints(1500, 1800).findFirst().getAsInt();
			this.str = r.ints(800, 900).findFirst().getAsInt();
			...
			this.level = r.ints(46, 50).findFirst().getAsInt();
			this.hp = r.ints(2000, 3000).findFirst().getAsInt();
			this.str = r.ints(3000, 4500).findFirst().getAsInt();
			this.dex = r.ints(1500, 2250).findFirst().getAsInt();
