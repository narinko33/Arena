...
public class Npc extends Gladiator {
	...
	public void npcStatus(Player p) {
		if (p.level <= 5) {
			...
			this.hp = r.ints(200, 300).findFirst().getAsInt();
			...
			this.hp = r.ints(250, 350).findFirst().getAsInt();
			...
			this.hp = r.ints(350, 600).findFirst().getAsInt();
			...
			this.hp = r.ints(400, 900).findFirst().getAsInt();
			...
			this.hp = r.ints(500, 1300).findFirst().getAsInt();
			...
			this.hp = r.ints(600, 1800).findFirst().getAsInt();
